...
class CoTAgent:
    def __init__(self,                 
                 ...
                 save_dir: str = "./result/cot_result.jsonl"
                 ) -> None:
    ...
    def run(self,
        ...
        if self.is_finished:
            return
        if self.trial_n > 0 and not self.is_finished and reflexion_strategy != ReflexionStrategy.NONE:
...
class ReactAgent:
    def __init__(self,                 
                 ...
                 react_examples: str = WEBTHINK_SIMPLE6,
...
class ReflectionAgent(ReactAgent):
    def __init__(self,
                 ...
                 environment: QAEnv = QAEnv("train"),
                 reflect_examples: str = REFLECTIONS,
