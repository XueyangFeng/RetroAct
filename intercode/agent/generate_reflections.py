from experiments.intercode_trial import llm
from experiments.utils.utils import LocalModel                             
                  
from typing import List, Dict, Any

with open("/data/fengxueyang/intercode/prompt_gen/few_shot.txt", 'r') as f:
...
def update_memory(trial_log_path: str, env_configs: List[Dict[str, Any]], model) -> List[Dict[str, Any],]:
    ...
    for i, env in enumerate(env_configs):
        ...
        if not env['is_success'] and not env['skip']:
            ...
            reflection: str = model.inference(reflection_query)
